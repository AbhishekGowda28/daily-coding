...
def LiveScore(showNotification):
    ...
    """
        other urls :    http://mapps.cricbuzz.com/cbzios/series/<series_ID>/teams,
                        http://mapps.cricbuzz.com/cbzios/news/index/team/1
                        http://mapps.cricbuzz.com/cbzios/pointtable/<series_ID>
                        http://mapps.cricbuzz.com/cbzios/match/<match_ID>
    """
    ...
    def categorizeMatches():
        for match in matches:
            ...
            elif(match["header"]["state"] == "innings break" or match["header"]["state"] == "tea" or match["header"]["state"] == "stump" or match["header"]["state"] == "lunch"):
    ...
    def displayMatchData(matches):
        if(len(matches) != 0):
            for match in matches:
                ...
                team1_id = team1["id"]
                # team2_id = team2["id"]                 """team2_id is not used anywhere so can be ignored"""
